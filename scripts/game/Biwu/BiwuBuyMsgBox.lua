...
function BiwuBuyMsgBox:loadRes()
	display.addSpriteFramesWithFile("res/ui/ui_common_button.plist", "res/ui/ui_common_button.png")
	display.addSpriteFramesWithFile("res/ui/ui_coin_icon.plist", "res/ui/ui_coin_icon.png")

end

function BiwuBuyMsgBox:releaseRes()
	display.removeSpriteFramesWithFile("res/ui/ui_common_button.plist", "res/ui/ui_common_button.png")
	display.removeSpriteFramesWithFile("res/ui/ui_coin_icon.plist", "res/ui/ui_coin_icon.png")
