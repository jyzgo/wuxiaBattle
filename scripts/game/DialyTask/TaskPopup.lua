...
function TaskPopup:setUpView()
    ...
    display.addSpriteFramesWithFile("res/ui/ui_icon_frame.plist", "res/ui/ui_icon_frame.png")
...
function TaskPopup:closeSelf()
    ...
    display.removeSpriteFramesWithFile("res/ui/ui_icon_frame.plist", "res/ui/ui_icon_frame.png")
