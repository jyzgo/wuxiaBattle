--[[
 ...
 function GuildDadianScene:createAllLbl() 
    ...
    -- 当前等级 
    self._levelLbl = self:createTTF("LV." .. tostring(self._level), yColor, self._rootnode["cur_level_lbl"]) 
    ...
    self._curCoinLbl = self:createTTF(tostring(self._currentUnionMoney), FONT_COLOR.WHITE, self._rootnode["cur_coin_lbl"]) 
    ...
    local function createFunc(index)
        ...
        return item:create({ 
                ...
                contributeFunc = function(cell) 
                    ...
                    if contInfo.type == 1 and game.player:getSilver() < contInfo.number then 
                        bCan = false 
