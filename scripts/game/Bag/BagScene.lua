        ...
        callback = function(data)
            ...
            if #data["0"] > 0 then
                ...
                if #data["1"] ~= #self._item[self._curView] then
                    ...
                    self._bagItemList:resetCellNum(#self._item[self._curView])
                else
                    self._item[self._curView] = data["1"]
                    self._bagItemList:resetCellNum(#self._item[self._curView], true)
                end
...
--
    ...
    local function onJingLian()
        local req = RequestInfo.new({
            ...
            oklistener = function(data)
                data["2"]._id = self._item[self._curView][cell:getIdx() + 1]._id
